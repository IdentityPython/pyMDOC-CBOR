...
class MsoX509Fabric:
    ...
    def selfsigned_x509cert(self, encoding :str = "DER"):
        ...
        cert = x509.CertificateBuilder().subject_name(
            ...
            datetime.datetime.utcnow() + datetime.timedelta(days=10) # see settings.PYMDOC_EXP_DELTA_HOURS
        ).add_extension(
            x509.SubjectAlternativeName([x509.DNSName(u"localhost")]), # please don't!
            critical=False,
